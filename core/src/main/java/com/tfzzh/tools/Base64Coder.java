...
public class Base64Coder {
	...
	public static String encodeLines(final byte[] in) {
		return Base64Coder.encodeLines(in, 0, in.length, 76, Base64Coder.systemLineSeparator);
	}
