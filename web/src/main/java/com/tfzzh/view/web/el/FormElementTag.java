...
public class FormElementTag extends TagSupport {
	...
	/**
	 * @author Xu Weijie
	 * @dateTime 2012-8-3 下午5:52:01
	 */
	private static final long serialVersionUID = 7231791217794839368L;
	...
	/**
	 * 信息录入类型：<br />
	 * text|hidden|password|textarea|file|colorval<br />
	 * 
	 * @author Xu Weijie
	...
	public int doStartTag() throws JspException {
		...
		if (null != this.type.getShowStart()) {
	...
	/**
	 * 设置信息录入类型：<br />
	 * show|text|hidden|password|textarea|file<br />
	 * 
	 * @author Xu Weijie
	 * @dateTime 2012-7-19 下午9:15:23
	...
	public void setType(final String type) {
		this.type = ElementTypeEnum.getType(type);
	}
