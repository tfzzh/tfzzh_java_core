 ...
 * @dateTime 2012-7-23 上午2:51:37
 */
public class FormSourceCascadeSelectTag extends TagSupport {

	/**
	 * @author Xu Weijie
	 * @dateTime 2013-1-17 上午1:58:29
	 */
	private static final long serialVersionUID = 2557623554738841212L;
	...
	public int doStartTag() throws JspException {
		...
		// 调用js
		sb.append(this.type.showJsFunction()).append("('").append(this.att).append("',").append(this.att).append("Data,'").append(this.className).append("','").append(this.className).append("','").append(this.other).append("','").append(this.shell).append("','").append(this.shellClassName).append("','").append(this.shellOther).append("');");
		sb.append("</script>");
		try {
